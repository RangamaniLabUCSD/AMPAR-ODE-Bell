function dydt= AMPARODE_linear_CaCaMInput(t,y,CIC, PIC,Influx, EnEx, CaCaMinput,tv)
...
rcamkiip = part1camkii - koff13*CaMKIIp;
rcamkii = -rcamkiip;
...
dydt(10) = rmemForAmem*EnEx.../
    -kbind*scaff*Amem + krelease*Abound + baseInflux*Influx; %Amem
