function [t,y]= call_AMPARODE_bistable_CaCaMInput_scaleC1C2(CIC, c1var, c2var, CaCaMinput)
%close all
%clear
...
%%%%=
Amem_IC = (7.288/(6.022e23))*1e12;      %moles/m2 12 7.288
%%%%
...
[t,y] = ode23s(@(t,y) AMPARODE_bistable_CaCaMInput_scaleC1C2(t,y,c1var, c2var, CaCaMinput,tspan), tspan, original_cond);
