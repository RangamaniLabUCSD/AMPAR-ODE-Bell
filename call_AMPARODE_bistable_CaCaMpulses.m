function [t,y]= call_AMPARODE_bistable_CaCaMpulses(CIC, PIC, CaCaMinput)
%close all
%clear
...
[t,y] = ode23s(@(t,y) AMPARODE_bistable_CaCaMpulses(t,y, CaCaMinput,tspan), tspan, original_cond);
