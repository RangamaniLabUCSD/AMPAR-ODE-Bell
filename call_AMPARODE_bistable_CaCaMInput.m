function [t,y]= call_AMPARODE_bistable_CaCaMInput(CIC, PIC, Influx, EnEx, CaCaMinput)
%close all
%clear
...
[t,y] = ode23s(@(t,y) AMPARODE_bistable_CaCaMInput(t,y,CIC, PIC, Influx, EnEx,CaCaMinput,tspan), tspan, original_cond);
