function [t,y]= call_AMPARODE_linear_CaCaMInput_scaleWhole(CIC,En, Ex, CaCaMinput)
%close all
%clear
...
[t,y] = ode23s(@(t,y) AMPARODE_linear_CaCaMInput_scaleWhole(t,y,En, Ex, CaCaMinput1,tspan), tspan, original_cond);
sol1 = y;
newIC(:) = [y(end,:)];
[t,y] = ode23s(@(t,y) AMPARODE_linear_CaCaMInput_scaleWhole(t,y,En, Ex, CaCaMinput,tspan), tspan, newIC);
sol2 = y;
